...
this the official repo : https://github.com/Uniswap/uniswap-ai
...
| Best For         | Complexity | Full Guide                                             |
    ...
    Step 1: Choose the flow [#step-1-choose-the-flow]

    Pick where users should land: `swap`, `add`, or `remove`.

    Step 2: Build and test the URL [#step-2-build-and-test-the-url]
    ...
    Step 3: Add it to your product [#step-3-add-it-to-your-product]
...
| Best For                     | Complexity | Full Guide                                              |
    ...
    Step 2: Authenticate your requests [#step-2-authenticate-your-requests]
    ...
    Step 3: Request a quote [#step-3-request-a-quote]
    ...
    Step 4: Build the execution request [#step-4-build-the-execution-request]
    ...
    Step 5: Sign and submit [#step-5-sign-and-submit]
...
| Best For                                 | Complexity | Full Guide                               |
    ...
    Step 1: Install SDK packages [#step-1-install-sdk-packages]
    ...
    Step 2: Build config and get a quote [#step-2-build-config-and-get-a-quote]
    ...
    * `hookData`: hook payload (`0x00` if unused)
    ...
    Step 3: Execute through Universal Router [#step-3-execute-through-universal-router]
    ...
    Step 4: Add approvals and production data flows [#step-4-add-approvals-and-production-data-flows]
...
| Best For                                        | Complexity | Full Guide                                                       |
    ...
    Step 1: Install dependencies and import interfaces [#step-1-install-dependencies-and-import-interfaces]
    ...
    Step 2: Set up your contract [#step-2-set-up-your-contract]
    ...
    Step 3: Build your swap command [#step-3-build-your-swap-command]
...
> Onchain swaps require you to pay gas. Consider using the Uniswap API with UniswapX for gasless execution when possible.
    ...
    Optional Path: Customize swap behavior with hooks [#optional-path-customize-swap-behavior-with-hooks]
